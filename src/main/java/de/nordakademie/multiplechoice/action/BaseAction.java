...
public abstract class BaseAction extends ActionSupport implements SessionAware {
   ...
   */
  UserType getUserType() throws NotLoggedInException {
   ...
   */
  Student getStudentFromSession() throws NotLoggedInException, GenericErrorException {
   ...
   */
  Lecturer getLecturerFromSession() throws NotLoggedInException, GenericErrorException {
    String userMail = getUserMail();
   ...
   */
  String getI18NValue(final String key) {
